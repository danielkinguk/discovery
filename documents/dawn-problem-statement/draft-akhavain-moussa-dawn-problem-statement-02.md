...
docname: draft-akhavain-moussa-dawn-problem-statement-02
submissiontype: IETF
workgroup:
category: info
ipr: trust200902
...
**Responsible Party**: The party that is operationally accountable for the entity's behaviour, including security, correctness, and policy compliance. This may differ from the control owner. This dimension informs trust and attestation requirements in discovery.
