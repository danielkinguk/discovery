...
1. Administrivia and purpose of the BoF
      ...
      - Content: Usual meeting details. Purpose and non-purpose of BoF.
      - Time: 10 minutes (10/120)
   
2. Scene-setting, terminology, and problem statement
      - Potentinal presenter: Arashmid Akhavain (Huawei Canada)
      - Content: What are we talking about when we say "entity" and "discovery"? What is the essence of the problem to be solved?
      - References:
...
3. Overview of categories of use cases
      - Potential presenter: Kehan Yao (China Mobile)
...
4. Solution requirements
      - Potential presenter: Dan King (Old Dog Consulting)
...
8. Wrap-up / Next steps
      - Presenters: Chairs and ADs
      - Content: What was heard. Actions and next steps
