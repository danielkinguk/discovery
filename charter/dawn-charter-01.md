...
The principle use cases that this working group will focus on are how
an AI agent can find another AI agent with specific capabilities, 
...
communicated as well, such as how many tokens the entity can support, whether
